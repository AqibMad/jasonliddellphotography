...
interface SdkInterface {
   ...
   *   The HTTP response.
   *
   * @deprecated in commerce_paypal:1.11.0 and is removed from commerce_paypal:3.0.0. Use SdkFactoryBase::getAccessToken() instead.
   * @see https://www.drupal.org/project/commerce_paypal/issues/3574338
   */
