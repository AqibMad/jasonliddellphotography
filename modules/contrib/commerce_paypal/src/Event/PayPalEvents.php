...
final class PayPalEvents {
   ...
   * @see \Drupal\commerce_paypal\Event\CheckoutOrderRequestEvent.php
   */
  public const FASTLANE_CREATE_ORDER_REQUEST = 'commerce_paypal.fastlane_create_order_request';
   ...
   * @see \Drupal\commerce_paypal\Event\CheckoutOrderRequestEvent.php
   */
  public const FASTLANE_UPDATE_ORDER_REQUEST = 'commerce_paypal.fastlane_update_order_request';
